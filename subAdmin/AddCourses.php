...
>>>>>>> 1240e510ece5eeca275deb0023b3b8d3cc8ddcf2
  ...
  if ($uploadOk == 0) {
    ...
    if (move_uploaded_file($_FILES["course_data_2"]["tmp_name"], $target_file)) {
      $dbconn = pg_connect("host=localhost port=5432 dbname=platform user=postgres password=postgres");
      $sql = "insert into public.courses(course_name,owner_email,course_data,start_date,end_date,description,capacity)values('" . $_POST['course_name'] . "','"  . $_POST['owner_email'] .  "','" . basename($_FILES["course_data_2"]["name"]) . "','" . $_POST['start_date'] . "','" . $_POST['end_date'] . "','" . $_POST['description'] . "','" . $_POST['capacity'] . "')";
              ...
              <form method="post" enctype="multipart/form-data">
                <table class="content-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>Data File : </td>
                      <td><input type="file" class="form-control" id="course_data_2" placeholder="Insert Data File" name="course_data_2"></td>
                    </tr>
                    <tr>
                      <td>Start Date : </td>
                    ...
                    <td colspan="2">
                      <center><input type="submit" name="submit3" class="btn btn-primary" value="Submit"></center>
                    </td>
